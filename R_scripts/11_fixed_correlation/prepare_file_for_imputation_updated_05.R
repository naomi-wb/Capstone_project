...
getSE <- function(species_name, cor =  -0.5, sim_N = 10000){
...
saveRDS(joined_dat_final, "Intermediate data files/file_for_imputation_m05_updated.RDS")
...
ggsave("Figures/Supplementary_figures/intercept_and_slope_trait_relationships_m05_updated.png", 
...
ggsave("Figures/Supplementary_figures/density_and_rel_abund_trait_relationships_m05_updated.png", 
