...
ggsave("Figures/Supplementary_figures/number_of_data_points_per_species.png",
...
ggsave("Figures/Supplementary_figures/brms_histograms.png",
       width=6.8, height=5.6, units="in")
...
write_csv(blups_df, "./Intermediate data files/spp_all.csv")
...
ggsave("Figures/Supplementary_figures/training_data_density_vs_abundance.png",
       width=6.8, height=5.6, units="in")
