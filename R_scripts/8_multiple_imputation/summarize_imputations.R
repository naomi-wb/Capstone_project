...
ggsave("Figures/Supplementary_figures/density_vs_weights_across_grids.png", 
...
ggsave("Figures/Supplementary_figures/histogram_of_weighted_densities.png",
...
ggsave("Figures/Supplementary_figures/histogram_of_density_standard_errors.png",
       width=6.8, height=5.6, units="in")
...
saveRDS(all_bird_total_results, "Intermediate data files/imputation_summaries/total_number_of_individual_birds.RDS")
...
save_example_species_function <- function(example_species) {
  ...
  saveRDS(species_dat, paste0("Intermediate data files/imputation_summaries/", example_species, ".RDS"))
...
saveRDS(species_specific_results, "Intermediate data files/imputation_summaries/species_specific_results_summary.RDS")
...
saveRDS(order_results, "Intermediate data files/imputation_summaries/order_specific_results_summary.RDS")
...
saveRDS(family_results, "Intermediate data files/imputation_summaries/family_specific_results_summary.RDS")
...
saveRDS(realm_results, "Intermediate data files/imputation_summaries/realm_specific_results_summary.RDS")
...
saveRDS(trophic_level_results, "Intermediate data files/imputation_summaries/trophic_level_specific_results_summary.RDS")
...
saveRDS(trophic_niche_results, "Intermediate data files/imputation_summaries/trophic_niche_specific_results_summary.RDS")
...
saveRDS(foraging_niche_results, "Intermediate data files/imputation_summaries/foraging_niche_specific_summary_results.RDS")
...
write_csv(table_s1, "Tables/all_species_summary_table.csv")
